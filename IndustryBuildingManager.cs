    ...
    public class IndustryBuildingManager
    {
        ...
        public static int GetExtendedResourcePrice(ExtendedTransferManager.TransferReason material, ItemClass.Service sourceService = ItemClass.Service.None)
        {
            return UniqueFacultyAI.IncreaseByBonus(UniqueFacultyAI.FacultyBonus.Science, material switch
            {
                ...
                ExtendedTransferManager.TransferReason.Fruits => 200,
                ExtendedTransferManager.TransferReason.Vegetables => 200,
                ExtendedTransferManager.TransferReason.Cotton => 200,
                ExtendedTransferManager.TransferReason.Wool => 1500,
                ExtendedTransferManager.TransferReason.FoodProducts => 900,
                ExtendedTransferManager.TransferReason.BeverageProducts => 900,
                ExtendedTransferManager.TransferReason.BakedGoods => 9000,
                ExtendedTransferManager.TransferReason.CannedFish => 900,
                ExtendedTransferManager.TransferReason.Furnitures => 10000,
                ExtendedTransferManager.TransferReason.ElectronicProducts => 9500,
                ExtendedTransferManager.TransferReason.IndustrialSteel => 1000,
                ExtendedTransferManager.TransferReason.Tupperware => 600,
                ExtendedTransferManager.TransferReason.Toys => 850,
                ExtendedTransferManager.TransferReason.PrintedProducts => 3000,
                ExtendedTransferManager.TransferReason.TissuePaper => 2250,
                ExtendedTransferManager.TransferReason.Cloths => 3500,
                ExtendedTransferManager.TransferReason.PetroleumProducts => 5000,
                ExtendedTransferManager.TransferReason.Cars => 20000,
                ExtendedTransferManager.TransferReason.Footwear => 3500,
                ExtendedTransferManager.TransferReason.HouseParts => 5000,
                ExtendedTransferManager.TransferReason.Ship => 125000,
                _ => 0,
            });
        }
