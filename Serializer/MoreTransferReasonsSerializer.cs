...
{
    public class MoreTransferReasonsSerializer : ISerializableDataExtension
    {
        ...
        public const string DataID = "MoreTransferReasons";

        public static MoreTransferReasonsSerializer instance = null;
        ...
        public void OnLoadData()
        {
                    ...
                    if (Data != null && Data.Length > 0)
                    {
                        ...
                        if (SaveGameFileVersion <= DataVersion)
                        {
                            while (Index < Data.Length)
                            {
                                ...
                                CheckStartTuple("ExtendedTransferManagerSerializer", SaveGameFileVersion, Data, ref Index);
                                ExtendedTransferManagerSerializer.LoadData(SaveGameFileVersion, Data, ref Index);
                                CheckEndTuple("ExtendedTransferManagerSerializer", SaveGameFileVersion, Data, ref Index);
                                break;
                            }
                        }
                        else
                        {
                            string sMessage = "This saved game was saved with a newer version of MoreTransferReasons.\r\n";
                            sMessage += "\r\n";
            ...
            {
                string sErrorMessage = "Loading of MoreTransferReasons save game settings failed with the following error:\r\n";
                sErrorMessage += "\r\n";
        ...
        public void OnSaveData()
        {
            ...
            try
            {
                if (m_serializableData != null)
                {
                    ...
                    ExtendedTransferManagerSerializer.SaveData(Data);
            ...
            {
                Debug.Log("MoreTransferReasons: Could not save data. " + ex.Message);
            }
            Debug.Log("MoreTransferReasons: OnSaveData - Finish");
        }
