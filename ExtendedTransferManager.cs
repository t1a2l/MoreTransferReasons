...
namespace MoreTransferReasons
{
    public class ExtendedTransferManager : SimulationManagerBase<ExtendedTransferManager, TransferProperties>, ISimulationManager
    {
        ...
        public enum TransferReason
        {
            ...
            MealsLow = 3, // serve low end food
            MealsMedium = 4, // serve normal food
            MealsHigh = 5,  // serve high end food
            PoliceVanCriminalMove = 6, // carry prisoners from small police stations to big ones
            PrisonHelicopterCriminalPickup = 7, // pick up from big police stations
            PrisonHelicopterCriminalMove = 8, // transfer to prison
            Anchovy = 9,
            Salmon = 10,
            Shellfish = 11,
            Tuna = 12,
        ...
        public static TransferReason GetFrameReason(int frameIndex)
        {
            return frameIndex switch
            {
                ...
                7 => TransferReason.MealsLow,
                9 => TransferReason.MealsMedium,
                11 => TransferReason.MealsHigh,
                13 => TransferReason.PoliceVanCriminalMove,
                15 => TransferReason.PrisonHelicopterCriminalPickup,
                17 => TransferReason.PrisonHelicopterCriminalMove,
                19 => TransferReason.Anchovy,
                21 => TransferReason.Salmon,
                23 => TransferReason.Shellfish,
                25 => TransferReason.Tuna,
                27 => TransferReason.Algae,
                29 => TransferReason.Seaweed,
                31 => TransferReason.Trout,
                33 => TransferReason.Milk,
                35 => TransferReason.Fruits,
                37 => TransferReason.Vegetables,
                39 => TransferReason.Cows,
                41 => TransferReason.HighlandCows,
                43 => TransferReason.Sheep,
                45 => TransferReason.Pigs,
                47 => TransferReason.FoodProducts,
                49 => TransferReason.BeverageProducts,
                51 => TransferReason.BakedGoods,
                53 => TransferReason.CannedFish,
                55 => TransferReason.Furnitures,
                57 => TransferReason.ElectronicProducts,
                59 => TransferReason.IndustrialSteel,
                61 => TransferReason.Tupperware,
                63 => TransferReason.Toys,
                65 => TransferReason.PrintedProducts,
                67 => TransferReason.TissuePaper,
                69 => TransferReason.Cloths,
                71 => TransferReason.PetroleumProducts,
                73 => TransferReason.Cars,
                75 => TransferReason.Footwear,
                77 => TransferReason.HouseParts,
